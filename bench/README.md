...
- **view** — Inspect or compare LoCoMo artifacts: `cargo run -p elephant-bench --bin view -- <a.json> [b.json]`
- **longmemeval-view** — Inspect or compare LongMemEval artifacts: `cargo run -p elephant-bench --bin longmemeval-view -- <a.json> [b.json]`
